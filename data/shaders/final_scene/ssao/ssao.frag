...
void main()
{
    ...
    vec3 fragPos = texture(gViewPositionMetallic, texCoords).rgb;
    vec3 normal = normalize(texture(gViewNormalRoughness, texCoords).rgb);
    ...
    for(int i = 0; i < kSampleCount; ++i)
    {
        ...
        // get sample depth
        float sampleDepth = texture(gViewPositionMetallic, offset.xy).z; // get depth value of kernel sample
